...
from .exts import db
from .models import User, Book, Unit, Task, BookImage, Content, Attach, BookImageEnum, ContentTypeEnum, \
    ContentAttachEnum
from .forms import AddBookForm, AddContentForm, EditContentForm

bp = Blueprint("book", __name__)

UPLOAD_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), "book_image")
